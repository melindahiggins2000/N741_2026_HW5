---
title: "NRSG 741 - Homework 4 - Linear Regression - ASSIGNMENT"
...
## Linear Regression
### HOMEWORK ASSIGNMENT - Analysis of **Chinstrap** penguins

Let's load the Penguins data. For this homework ASSIGNMENT, let's pull out the data for the **Chinstrap** penguins, and we'll remove the `NA`'s here at the beginning for the penguins with missing body size measurements.
